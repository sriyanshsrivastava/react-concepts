...
function App() {
  ...
  return (
    <>
      <div className='w-full max-w-md mx-auto shadow-md rounded-lg p-4 my-8 text-orange-500 bg-gray-800 h-fit'>
        ...
        <div className='flex shadow rounded-lg overflow-hidden mb-4'>
          ...
          <button onClick= {copyPasswordToClipboard} className='outline-none bg-blue-700 text-white px-3 py-0.5 shrink-0 cursor-pointer font-bold uppercase'>Copy</button>
        </div>
